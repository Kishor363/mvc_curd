...
<body>
<h1 color="pink" align="center">Update Book here </h1>
...
<div class="input-group input-group-lg">
  <span class="input-group-text" id="inputGroup-sizing-lg">Book Id</span>
  <form:input path="bookId" type="text" readonly="true" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg"/>
</div>
